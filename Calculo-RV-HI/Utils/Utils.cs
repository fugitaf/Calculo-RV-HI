    ...
    public static class Utils
    {
        ...
        public static List<PosicaoAnalitica> CalculaPosicaoAnalitica(List<Certificado> certificados, Saldo saldo, Fundos fundos)
        {
            ...
            foreach (Certificado Cert in certificados)
            {
                ...
                listaPeriodos = Utils.CalculoPorPeriodo(listaPeriodos, Cert.CotacaoAplicacaoAjustada(), fundos.CotacaoMaisRecente, Cert.SaldoCotasCertificado,
        ...
        public static void GravaRegistro(string registro)
        {
            try
            {
                ...
                string pathSaida = @"C:\Users\fefug_skli85i\Documents\Temp_RV_HI\Saida";
                string pathCalc = @"C:\Users\fefug_skli85i\Documents\Temp_RV_HI\Saida\CALC-" + dataHora + ".csv";
